...
public class ErrorMessages {
    ...
    public static final String EMAIL_IS_ALREADY_TAKEN = "email.alreadyTaken";
    ...
    public static final String NICKNAME_SIZE = "nickname.size";
    public static final String FAVOURITE_GENRE_REQUIRED = "favouriteGenre.required";
    public static final String DATE_OF_BIRTH_REQUIRED = "dateOfBirth.required";
    public static final String DATE_OF_BIRTH_INVALID = "dateOfBirth.invalid";
    public static final String FAVOURITE_TITLE_REQUIRED = "favouriteTitle.required";
    public static final String WORK_OF_CULTURE_TYPE_REQUIRED = "workOfCultureType.required";
